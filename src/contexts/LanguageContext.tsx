...
const translations: Translations = {
  fr: {
    ...
    'services.subtitle': 'Nos services spécialisés',
    'services.software.title': 'Développement de logiciels',
    'services.software.description': 'Solutions personnalisées adaptées à vos besoins spécifiques',
    'services.automation.title': 'Automatisation des processus',
    'services.automation.description': 'Optimisez vos opérations et gagnez un temps précieux',
    'services.websites.title': 'Sites Web sur mesure',
    'services.websites.description': 'Design web moderne et responsive',
    'services.digital.title': 'Projets numériques sur mesure',
    'services.digital.description': 'Solutions digitales parfaitement adaptées à votre entreprise',
  ...
  en: {
    ...
    'services.subtitle': 'Our specialized services',
    'services.software.title': 'Software Development',
    'services.software.description': 'Custom solutions tailored to your specific needs',
    'services.automation.title': 'Process Automation',
    'services.automation.description': 'Optimize your operations and save valuable time',
    'services.websites.title': 'Custom Websites',
    'services.websites.description': 'Modern and responsive web design',
    'services.digital.title': 'Custom Digital Projects',
    'services.digital.description': 'Digital solutions perfectly adapted to your business',
  ...
  pt: {
    ...
    'services.subtitle': 'Nossos serviços especializados',
    'services.software.title': 'Desenvolvimento de Software',
    'services.software.description': 'Soluções personalizadas adaptadas às suas necessidades específicas',
    'services.automation.title': 'Automação de Processos',
    'services.automation.description': 'Otimize suas operações e economize tempo valioso',
    'services.websites.title': 'Sites Personalizados',
    'services.websites.description': 'Design web moderno e responsivo',
    'services.digital.title': 'Projetos Digitais sob Medida',
    'services.digital.description': 'Soluções digitais perfeitamente adaptadas ao seu negócio',
