...
const translations = {
  fr: {
    ...
    'about.description': 'GMV Solution est née de la vision commune de trois entrepreneurs passionnés par la technologie: Gabriel, Matheus et Vinicius. Ils sont unis par la conviction que l\'innovation peut résoudre les défis les plus complexes du quotidien. Le nom de l\'entreprise est un acronyme de notre mission principale: GENERATE MORE VALUE.',
    'about.card1.title': 'Solutions sur mesure',
    'about.card1.description': 'Chaque client a des besoins différents, nous ne faisons pas du "copie-collé". Nous créons des stratégies adaptées à leur secteur, budget et objectifs spécifiques.',
    'about.card2.title': 'ROI first (Retour sur investissement)',
    'about.card2.description': 'Toutes nos actions sont pensées en fonction du ROI. Pas de vanity metrics : ce qui compte, ce sont les ventes, les leads qualifiés et la rentabilité.',
    'about.card3.title': 'Approche collaborative',
    'about.card3.description': 'Nous travaillons main dans la main avec le client, en gardant une communication fluide et transparente pour qu\'il ait toujours de la visibilité sur l\'avancement et les résultats.',
    
    // Mission Vision Values
    'mvv.title': 'Notre mission, vision et valeurs',
    'mvv.mission.title': 'Mission',
    'mvv.mission.description': 'Fournir aux entreprises et aux particuliers des solutions technologiques innovantes qui simplifient les processus, réduisent les coûts et optimisent l\'efficacité opérationnelle.',
    'mvv.vision.title': 'Vision',
    'mvv.vision.description': 'Être la référence à Paris en matière de transformation numérique, en créant un avenir où la technologie est véritablement au service des personnes et des organisations.',
    'mvv.values.title': 'Valeurs',
    'mvv.values.list': 'Innovation constante • Confiance mutuelle • Excellence technique • Engagement envers les résultats',
    ...
    'impact.efficiency.description': 'Amélioration de la productivité opérationnelle',
    
    // Problems / Challenges
    'problems.title': 'Les défis d\'aujourd\'hui',
    'problems.time.title': 'Perte de temps inutile',
    'problems.time.description': 'Les processus manuels et répétitifs prennent un temps précieux qui pourrait être consacré à la croissance et à l\'innovation.',
    'problems.cost.title': 'Coûts d\'exploitation élevés',
    'problems.cost.description': 'Les inefficacités systémiques épuisent les ressources financières, affectant la compétitivité et la durabilité des entreprises.',
    'problems.efficiency.title': 'Faible efficacité opérationnelle',
    'problems.efficiency.description': 'Le manque d\'intégration entre les systèmes et les processus entraîne des erreurs, des retouches et des opportunités manquées.',
  ...
  en: {
    ...
    'about.description': 'GMV Solution was born from the common vision of three entrepreneurs passionate about technology: Gabriel, Matheus and Vinicius. They are united by the belief that innovation can solve the most complex everyday challenges. The company name is an acronym for our main mission: GENERATE MORE VALUE.',
    'about.card1.title': 'Customized solutions',
    'about.card1.description': 'Each client has different needs, we don\'t do "copy-paste". We create strategies adapted to their sector, budget and specific objectives.',
    'about.card2.title': 'ROI first (Return on investment)',
    'about.card2.description': 'All our actions are designed based on ROI. No vanity metrics: what counts are sales, qualified leads and profitability.',
    'about.card3.title': 'Collaborative approach',
    'about.card3.description': 'We work hand in hand with the client, maintaining fluid and transparent communication so they always have visibility on progress and results.',
    
    // Mission Vision Values
    'mvv.title': 'Our mission, vision and values',
    'mvv.mission.title': 'Mission',
    'mvv.mission.description': 'Provide businesses and individuals with innovative technological solutions that simplify processes, reduce costs and optimize operational efficiency.',
    'mvv.vision.title': 'Vision',
    'mvv.vision.description': 'To be the reference in Paris for digital transformation, creating a future where technology truly serves people and organizations.',
    'mvv.values.title': 'Values',
    'mvv.values.list': 'Constant innovation • Mutual trust • Technical excellence • Commitment to results',
    ...
    'problems.time.description': 'Manual and repetitive processes take up valuable time that could be devoted to growth and innovation.',
    'problems.cost.title': 'High operating costs',
    'problems.cost.description': 'Systemic inefficiencies drain financial resources, affecting business competitiveness and sustainability.',
    'problems.efficiency.title': 'Low operational efficiency',
    'problems.efficiency.description': 'Lack of integration between systems and processes leads to errors, rework and missed opportunities.',
  ...
  pt: {
    ...
    'about.description': 'A GMV Solution nasceu da visão comum de três empreendedores apaixonados por tecnologia: Gabriel, Matheus e Vinicius. Eles são unidos pela convicção de que a inovação pode resolver os desafios mais complexos do cotidiano. O nome da empresa é um acrônimo de nossa missão principal: GENERATE MORE VALUE.',
    'about.card1.title': 'Soluções sob medida',
    'about.card1.description': 'Cada cliente tem necessidades diferentes, não fazemos "copia e cola". Criamos estratégias adaptadas ao seu setor, orçamento e objetivos específicos.',
    'about.card2.title': 'ROI first (Retorno sobre investimento)',
    'about.card2.description': 'Todas as nossas ações são pensadas em função do ROI. Sem métricas de vaidade: o que importa são as vendas, os leads qualificados e a rentabilidade.',
    'about.card3.title': 'Abordagem colaborativa',
    'about.card3.description': 'Trabalhamos de mãos dadas com o cliente, mantendo uma comunicação fluida e transparente para que ele sempre tenha visibilidade sobre o progresso e os resultados.',
    
    // Mission Vision Values
    'mvv.title': 'Nossa missão, visão e valores',
    'mvv.mission.title': 'Missão',
    'mvv.mission.description': 'Fornecer às empresas e particulares soluções tecnológicas inovadoras que simplificam processos, reduzem custos e otimizam a eficiência operacional.',
    'mvv.vision.title': 'Visão',
    'mvv.vision.description': 'Ser a referência em Paris em transformação digital, criando um futuro onde a tecnologia está verdadeiramente a serviço das pessoas e organizações.',
    'mvv.values.title': 'Valores',
    'mvv.values.list': 'Inovação constante • Confiança mútua • Excelência técnica • Compromisso com resultados',
    ...
    'impact.time.description': 'Tempo economizado graças aos processos automatizados',
    'impact.efficiency.value': '85%',
    'impact.efficiency.title': 'Aumento da eficiência',
    'impact.efficiency.description': 'Melhoria da produtividade operacional',
    
    // Problems / Challenges
    'problems.title': 'Os desafios de hoje',
    'problems.time.title': 'Perda de tempo inútil',
    'problems.time.description': 'Os processos manuais e repetitivos tomam tempo precioso que poderia ser dedicado ao crescimento e à inovação.',
    'problems.cost.title': 'Custos de operação elevados',
    'problems.cost.description': 'As ineficiências sistêmicas esgotam os recursos financeiros, afetando a competitividade e sustentabilidade das empresas.',
    'problems.efficiency.title': 'Baixa eficiência operacional',
    'problems.efficiency.description': 'A falta de integração entre sistemas e processos leva a erros, retrabalhos e oportunidades perdidas.',
